...
public class CornCropBlock extends CropsBlock 
{
	...
	public static final IntegerProperty AGE = BlockStateProperties.AGE_0_7; //5
	   ...
	   public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) 
		{
		 if (!worldIn.isRemote)
		 {
			 ...
			 else
			 {
				 ...
				 {
			        spawnAsEntity(worldIn, pos, new ItemStack(ProgressionItems.corn, 2));
	   ...
	   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) 
	   {
		   ...
		   return (worldIn.getLightSubtracted(pos, 0) >= 8) && checker(state, worldIn, pos);
		}
	   ...
	   protected IItemProvider getSeedsItem() {
	      return ProgressionItems.corn_seeds;
	   }
