...
import com.moreprogression.main.tileentity.EnderInfuserTileEntity;
...
public class EnderInfuserBlock extends CustomMachineBlock {

	public EnderInfuserBlock(Properties builder) {
		super(builder);
	}

	@Override
	public TileEntity createNewTileEntity(IBlockReader worldIn) {
		return new EnderInfuserTileEntity();
	}

	@Override
	public void openContainer(World world, BlockPos pos, PlayerEntity player) {
		TileEntity tileentity = world.getTileEntity(pos);
		if (tileentity instanceof EnderInfuserTileEntity && player instanceof ServerPlayerEntity) {
