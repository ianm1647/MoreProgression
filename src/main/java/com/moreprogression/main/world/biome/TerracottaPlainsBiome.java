...
public class TerracottaPlainsBiome extends Biome {
	...
	public TerracottaPlainsBiome() {
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(Feature.GRASS, new GrassFeatureConfig(ProgressionBlocks.terracotta_grass.getDefaultState()), Placement.COUNT_HEIGHTMAP_DOUBLE, new FrequencyConfig(5)));
