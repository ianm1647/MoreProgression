...
public class SilverwoodTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState TRUNK = ProgressionBlocks.silverwood_log.getDefaultState();
   private static final BlockState LEAF = ProgressionBlocks.silverwood_leaves.getDefaultState();

   public SilverwoodTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51429_1_, boolean p_i51429_2_) {
      super(p_i51429_1_, p_i51429_2_);
      setSapling((net.minecraftforge.common.IPlantable)ProgressionBlocks.silverwood_sapling);
   }
